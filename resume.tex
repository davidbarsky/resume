...
\begin{itemize}
    \item Designed and implemented a test data generation service, reducing p50 runtime from 3 hours to 35 minutes.
	\item Designed and mentored intern in implementing a Docker-based, horizontally-scalable test data generation system. This system reduced cold-start times from 10 minutes to 40 seconds.
...
\begin{itemize}
    \item Benchmarked job scheduling algorithms 
\end{itemize}
