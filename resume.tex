...
% Margins
\usepackage{geometry}
\geometry{letterpaper, left=40mm, right=40mm, top=20mm, bottom=20mm}
...
Completed additional coursework in History, Politics, and Classics.
...
\note{Current}
\textbf{Husk}
(\href{https://github.com/davidbarsky/husk}{https://github.com/davidbarsky/husk})
\begin{itemize}
...
\begin{itemize}
    \item Developed an iOS application that lets users to schedule time and connect with friends.
\end{itemize}
...
\textbf{Languages:} Swift, Java, JavaScript, Rust, Ruby, SQL \\
\textbf{Tooling:} PostgreSQL, DynamoDB, SQS, Redis, UIKit, XCTest, \LaTeX
...
\textbf{Activities:} Parliamentary Debate (Varsity), Rock Climbing
